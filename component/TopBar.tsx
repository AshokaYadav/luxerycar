export default function TopBar() {
  return (
    <div className="w-full bg-gradient-to-r from-yellow-500 via-amber-500 to-yellow-500 text-gray-900 text-sm">
      <div className="container mx-auto px-4 py-2.5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <svg className="w-4 h-4 text-gray-900 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 20 20">
            ...
            <a 
              ...
              className="hidden sm:flex items-center gap-2 hover:text-gray-900 transition-colors group"
            >
              <svg className="w-4 h-4 text-gray-900 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 20 20">
                <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
              </svg>
          ...
          <div className="flex items-center gap-2 text-xs">
            <div className="flex items-center gap-1.5 bg-gray-900/20 px-3 py-1 rounded-full">
