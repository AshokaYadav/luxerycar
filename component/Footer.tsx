            ...
            <div className="flex gap-3 mt-6">
              {[
                ...
                <a
                  key={i}
                  href="#"
                  className="w-10 h-10 bg-gray-800 hover:bg-gradient-to-br hover:from-blue-500 hover:to-indigo-500 rounded-lg flex items-center justify-center transition-all duration-300 group"
                >
            ...
            <ul className="space-y-5">
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+918693977777" className="text-gray-400 hover:text-blue-400 transition-colors text-sm block">+91 86939-77777</a>
                  <a href="tel:+919001144474" className="text-gray-400 hover:text-blue-400 transition-colors text-sm block">+91 90011-44474</a>
                </div>
              </li>
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@luxurycardrive.in" className="text-gray-400 hover:text-blue-400 transition-colors text-sm">
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-gray-400 text-sm">
            ...
            <p>
              Designed by{" "}
              <a
                href="https://www.quantumlooptechnology.com/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-400 hover:text-blue-300 transition-colors font-medium"
              >
                Quantum Loop Technology
              </a>
            </p>
          </div>
        </div>
